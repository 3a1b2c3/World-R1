...
def load_pretrained_nested_weights(
    ...
    state_dict0 = {k.replace("model.", "model.reconstruction_core."): v for k, v in state_dict0.items()}
    ...
    state_dict1 = {k.replace("model.", "model.metric_core."): v for k, v in state_dict1.items()}
