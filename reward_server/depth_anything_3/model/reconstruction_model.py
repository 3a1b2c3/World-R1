...
from reward_server.depth_anything_3.cfg import create_object
from reward_server.depth_anything_3.model.utils.transform import pose_encoding_to_extri_intri
from reward_server.depth_anything_3.utils.alignment import (
...
from reward_server.depth_anything_3.utils.geometry import affine_inverse, as_homogeneous, map_pdf_to_opacity
from reward_server.depth_anything_3.utils.ray_utils import get_extrinsic_from_camray
...
class DepthAnything3Net(nn.Module):
    ...
    def _process_gs_head(
        ...
        # The depth is defined in the reconstruction model's camera space,
...
class NestedDepthAnything3Net(nn.Module):
    ...
    def __init__(self, anyview: DictConfig, metric: DictConfig):
        ...
        """
        super().__init__()
        self.reconstruction_core = create_object(anyview)
        self.metric_core = create_object(metric)
    ...
    def forward(
        ...
        output = self.reconstruction_core(
        ...
        metric_output = self.metric_core(x)
